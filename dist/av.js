...
(function e(t, n, r) {
  ...
  }, { "../promise": 25, "../utils": 33 }], 13: [function (require, module, exports) {
    (function (global) {
      /**
       * 每位工程师都有保持代码优雅的义务
       * Each engineer has a duty to keep the code elegant
    ...
    (function (process) {
      ...
      **/
      ...
      module.exports = {
        ...
        // 计算 X-LC-Sign 的签名方法
        sign: function sign(key, isMasterKey) {
  ...
  }, { "./browserify-wrapper/ajax": 12, "_process": 7, "md5": 6, "underscore": 8 }], 34: [function (require, module, exports) {
    /**
     * 每位工程师都有保持代码优雅的义务
     * Each engineer has a duty to keep the code elegant
    **/
